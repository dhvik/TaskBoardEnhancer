...
function addToolbar() {
    ...
    views.after("<div class=\"mw-toolbar\"><div><select id=\"hideShow_option\">" + renderOption("Hide", hideShowOption) + renderOption("Show", hideShowOption) + "</select>:<select id=\"hide_option\">" + renderOption("None", hideOption) + renderOption("Done", hideOption) + renderOption("Reviewed,Done", hideOption) + renderOption("InReview,Reviewed,Done", hideOption) + "</select></div></div>");
    $("select#hide_option").change(updateHide);
    $("select#hideShow_option").change(updateHide);
}
...
function updateHide() {
    ...
    switch (hideOption.toLowerCase()) {
        case "none":
            setHidden(null, show);
            break;
        case "inreview,reviewed,done":
            setHidden(null, show);
            setHidden("InReview", !show);
